...
(function ($) {
    ...
    $.fn.percentageLoader = function (params) {
        var settings, canvas, percentageText, valueText, items, i, item, selectors, s, ctx, progress, progressToPrint,
...
//        percentageText.style.width = (settings.width.toString() - 2) + 'px';
      ...
      //aggiunti a manina
        percentageText.style.maxWidth = '100%';
        percentageText.style.fontSize = '3.5vw';
...
//        valueText.style.width = (settings.width - 2).toString() + 'px';
      ...
      //aggiunti a manina
        valueText.style.maxWidth = '100%';
        valueText.style.fontSize = '1vw';
...
//                percentageText.style.font = fontSize.toString() + 'px Helvetica Neue';

                //              aggiutno a manina  
                percentageText.style.font = '2.8vw Helvetica Neue';
                percentageText.style.top ='35%';
                percentageText.style.left = '18%';
                percentageText.className = 'col-lg-3 col-md-3 col-sm-3';
...
//                string = (progress * 100.0).toFixed(0) + '%';
                string = (progressToPrint * 100.0).toFixed(0) + '%';
...
//                valueText.style.font = smallSize.toString() + 'px Helvetica Neue';
//              valueText.style.font = smallSize.toString() + 'px BebasNeueRegular';
                
                //              aggiutno a manina  
                valueText.style.font = '1vw Helvetica Neue';
                valueText.style.top ='85%';
                valueText.style.left = '40%'
