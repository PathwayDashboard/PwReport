...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="alert alert-danger" role="alert" id="msError">
			<spring:message code="msError500" htmlEscape="false" />
		</div>
				...
				<div class="col-md-6">
					...
					<div id="datepicker_div" class="col-md-6" style="padding-top: 3px;">
						<div class="input-daterange input-group" id="datepicker" data-date-end-date="0d">
							<input id="day" type="text" class="input-sm form-control" readonly="readonly"
								name="day" 
...
<!-- 			</h4> -->
			<div class="row">
				<div class="col-lg-12">
					<h4 class="page-header" style="margin-bottom: 5px">
						 <img height="30px" src="resources/images/jpg/msband.png" style="margin-right: 5px"/> <spring:message code="outdoor.tagged.title" htmlEscape="false"  />
					</h4>
					<h6>
...
<!-- 			<div  align="right"> -->
					<div class="btn-group">
					  <button type="button" class="btn btn-info btn-lg dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					    <spring:message code="outdoor.other.options"/> <span class="caret"></span>
					  </button>
					  <ul class="dropdown-menu">
					    <li><a href="#" id="notTaggedLink"><spring:message	code="outdoor.notTagged.title.dropdown" htmlEscape="false" /></a></li>
					    <li><a href="#" id="notMonitoredLink"><spring:message code="outdoor.notMonitored.title.dropdown" htmlEscape="false" /></a></li>
					    <li role="separator" class="divider"></li>
					    <li> <h6 align="center"> <a id="notShownActivitiesInfosLink" role="button"><i class="fa fa-info-circle" aria-hidden="true"></i>  <span><spring:message code="details" /></span>  </a> </h6> </li>
					  </ul>
					</div>
					
<!-- 					<h6 align="right"> -->
<!-- 					<a id="notShownActivitiesInfosLink" role="button"> -->
<!-- 						<span> -->
<%-- 							<spring:message code="details" /> --%>
<!-- 						</span> -->
<!-- 					</a> -->
<!-- 					</h6> -->
					...
					<div class="row" style="margin-top:5px">
						<div class="col-lg-12" id="alert">
							<div id="notShownActivitiesInfos" style="display:none" class="alert alert-info" role="alert">
								<ul>
									<li><p><spring:message code="outdoor.notTagged.info.dropdown"  htmlEscape="false"/></p></li>
									<li><p><spring:message code="outdoor.notMonitored.info.dropdown"  htmlEscape="false"/></p></li>
								</ul>
							</div>
						</div>
					</div>
<!-- 				</div> -->
		...
		<div class="row" style="margin-top:5px">
			<div class="col-lg-12" id="alertSaved">
...
<!-- 						<div class="col-lg-12" id="alert"> -->
<!-- 							<div id="notShownActivitiesInfos" style="display:none" class="alert alert-info" role="alert"> -->
<%-- 				  				<p><spring:message code="outdoor.notTagged.info.dropdown"  htmlEscape="false"/></p> --%>
<%-- 				  				<p><spring:message code="outdoor.notMonitored.info.dropdown"  htmlEscape="false"/></p> --%>
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 					</div> -->
...
<%-- 										<td style='padding-right: 20px'> ${current.type} </td> --%>
										<td style='padding-right: 20px'> ${current.typeLabel} </td>
									</tr>
								</table>
							</h4>
						</div>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="alert alert-warning" role="alert" id="errorDates"><spring:message code="error.dates" htmlEscape="false"/></div>
			</div>
			<div class="modal-body">
				<div class="alert alert-info" role="alert">
			...
			<div class="modal-footer">
				<div class="col-lg-4" align="left">
					<button type="button" class="btn btn-success" id="resetDateTimePicker" style="background-color: #EBFCE3; color: #000">
						<spring:message code="outdoor.notTagged.reset"  htmlEscape="false"/>
					</button>
				</div>
