													...
													<div class="row">
														<div class="col-xs-3">
															<span class="glyphicons glyphicons-shoe-steps"></span> <img
																height="50px" src="resources/images/steps_white.png" />
														</div>
											...
											<div class="panel panel-red">
												<div class="panel-heading">
													<div class="row">
														...
														<div class="col-xs-9 text-right">
															<div class="huge" id="kcalday">1231</div>
															<spring:message code="hr.of.label" />
															<b><spring:message code="steps.total" /></b>
														</div>
													</div>
...
<!-- 				                             </div> -->
                                ...
                                <div class="col-xs-6 text-right">
                                    <div class="huge" id="hr"></div> <span id="of"><spring:message code="hr.of.label"/></span> <b> <span id="hrMin"></span></b>
                                </div>
                            </div>
