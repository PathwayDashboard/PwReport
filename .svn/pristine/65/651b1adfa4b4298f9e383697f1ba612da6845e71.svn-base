...
(function() {
    ...
    d.getDecimals = function(a) {
        var b = 0;
        isNaN(a) || (a = String(a),
        -1 != a.indexOf("e-") ? b = +a.split("-")[1] : -1 != a.indexOf(".") && (b = a.split(".")[1].length));
        return b
    }
    ;
    ...
    d.toNumber = function(a) {
        return "number" == typeof a ? a : +String(a).replace(/[^0-9\-.]+/g, "")
    }
    ;
    ...
    d.toCoordinate = function(a, b, c) {
        ...
        c && c < b && (b = c),
        e = +a,
        -1 != a.indexOf("!") && (e = b - +a.substr(1)),
        -1 != a.indexOf("%") && (e = b * +a.substr(0, a.length - 1) / 100));
        return e
    }
    ;
    ...
    d.generateNumber = function(a, b) {
        ...
        for (d = 0; d < e; d++)
            c += "0";
        return 0 > b ? +("0." + c + String(a)) : +(String(a) + c)
    }
    ;
...
(function() {
    ...
    d.AxisBase = d.Class({
        ...
        parseDatesDraw: function() {
            ...
            var u, w = this.gridAlpha, y, x = this.choosePeriod(0), A = x.period, x = x.count, z = d.getPeriodDuration(A, x);
            z < k && (A = g.period,
            x = g.count,
            z = k);
            g = A;
            ...
            if (g == A && 1 == x && this.centerLabelOnFullPeriod || this.autoWrap || this.centerLabels)
                n = z * this.stepWidth,
            ...
            if (0 < this.gridCountR)
                ...
                a = k; a <= B; a++) {
                    ...
                    if ("radar" == b.type) {
                        ...
                        this.rotate ? "date" == this.type && "middle" == this.gridPosition && (L = -z * this.stepWidth / 2) : "date" == this.type && (h = this.axisWidth - h);
                    f = !1;
                    ...
                    if (!isNaN(u))
                        for (h = 1; h < x; h += u)
                            ...
                            f = p + y * h,
                            f = d.resetDateToMin(new Date(f), A, u, t).getTime(),
...
(function() {
    ...
    d.ValueAxis = d.Class({
        ...
        updateData: function() {
            ...
            "date" != this.type && (isNaN(this.minimum) || (this.fullMin = this.minimum),
        ...
        draw: function() {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
                ...
                u > this.logGridLimit && (r = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1,
                            ...
                            !this.integersOnly || Math.round(c) == c)
                                if (isNaN(y) || +d.toFixed(c, y) == c) {
                                    ...
                                    if (c == this.baseValue && "radar" != a.type) {
                                        ...
                                        "H" == this.orientation ? 0 <= f && f <= t + 1 && (B = [f, f, f + k],
                                        C = [D, 0, l]) : 0 <= f && f <= D + 1 && (B = [0, t, t + k],
                                        C = [f, f, f + l]);
                                        B && (t = d.fitToBounds(2 * this.gridAlpha, 0, 1),
                                        isNaN(this.zeroGridAlpha) || (t = this.zeroGridAlpha),
                                        t = d.line(a.container, B, C, this.gridColor, t, 1, this.dashLength),
                                        t.translate(this.x, this.y),
                                        this.grid0 = t,
                                        a.axesSet.push(t),
                                        t.toBack(),
                                        d.setCN(a, t, this.bcn + "zero-grid-" + this.id),
                                        d.setCN(a, t, this.bcn + "zero-grid"))
                                    }
                                    if (!isNaN(A) && 0 < x && g < r - 1) {
                                        t = w / A;
                                        h && (A = w * (g + p) + this.minCalc,
                                        A = d.roundTo(A, this.maxDecCount + 1),
                                        u > this.logGridLimit && (A = Math.pow(10, g + p)),
                                        t = 10,
                                        A = (A - c) / t);
                                        f = this.gridAlpha;
                                        this.gridAlpha = this.minorGridAlpha;
                ...
                if (0 < z) {
                    ...
                    for (g = this.fillAlpha = 0; g < z; g++)
                        ...
                        t = new this.axisItemRenderer(this,k,"",!0,NaN,NaN,C),
                        this.pushAxisItem(t, A)),
                        l = NaN,
                        isNaN(C.value) || (l = this.getCoordinate(C.value),
                        t = new this.axisItemRenderer(this,l,C.label,!0,NaN,(k - l) / 2,C),
                        this.pushAxisItem(t, A)),
                        isNaN(k) && (l -= 3,
                        k = l + 3),
                        isNaN(k - l) || (k = new this.guideFillRenderer(this,l,k,C),
                        this.pushAxisItem(k, A),
                        A = k.graphics(),
                        C.graphics = A,
                        C.balloonText && this.addEventListeners(A, C));
                    this.fillAlpha = B
                }
                g = this.baseValue;
...
(function() {
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            void 0 != g.lineColor && (L = g.lineColor),
            void 0 != g.color && (u = g.color),
            isNaN(g.lineAlpha) || (C = g.lineAlpha),
            isNaN(g.dashLength) || (I = g.dashLength),
            ...
            isNaN(g.labelOffset) || (Z = g.labelOffset)) : "" === c && (B = 0);
            ...
            "V" == Oa && (n = 0);
            var ba;
            Q && "" !== c && (ba = a.autoWrap && 0 === n ? d.wrappedText(w, c, u, t, r, ga, k, Math.abs(h), 0) : d.text(w, c, u, t, r, ga, k),
            ga = ba.getBBox(),
            ha = ga.width,
            Pa = ga.height);
            if ("H" == Oa) {
                if (0 <= b && b <= ya + 1 && (0 < B && 0 < z && b + l <= ya + 1 && (fa = d.line(w, [b + l, b + l], [0, B], A, z, D),
                y.push(fa)),
                0 < C && (za = d.line(w, [b, b + va, b + va], [X, X + ma, ma], L, C, D, I),
                y.push(za))),
                v = 0,
                G = b,
                g && 90 == n && H && (G -= r),
                !1 === e ? (ga = "start",
                v = "bottom" == ea ? H ? v + B : v - B : H ? v - B : v + B,
                G += 3,
                0 < h && (G += h / 2 - 3,
                ga = "middle"),
                0 < n && (ga = "middle")) : ga = "middle",
                1 == ia && 0 < O && !g && !m && ca < ya && (e = d.fitToBounds(b, 0, ya),
                ca = d.fitToBounds(ca, 0, ya),
                Y = e - ca,
                0 < Y && (Ca = d.rect(w, Y, a.height, S, O),
                Ca.translate(e - Y + va, ma),
                y.push(Ca))),
                "bottom" == ea ? (v += X + r / 2 + da,
                H ? (0 < n ? (v = X - ha / 2 * Math.sin(T) - B - 3,
                G += ha / 2 * Math.cos(T) - 4 + 2) : 0 > n ? (v = X + ha * Math.sin(T) - B - 3 + 2,
                G += -ha * Math.cos(T) - Pa * Math.sin(T) - 4) : v -= B + r + 3 + 3,
                v -= Z) : (0 < n ? (v = X + ha / 2 * Math.sin(T) + B + 3,
                G -= ha / 2 * Math.cos(T)) : 0 > n ? (v = X + B + 3 - ha / 2 * Math.sin(T) + 2,
                G += ha / 2 * Math.cos(T)) : v += B + x + 3 + 3,
                v += Z)) : (v += ma + r / 2 - da,
                G += va,
                H ? (0 < n ? (v = ha / 2 * Math.sin(T) + B + 3,
                G -= ha / 2 * Math.cos(T)) : v += B + 3,
                v += Z) : (0 < n ? (v = -(ha / 2) * Math.sin(T) - B - 6,
                G += ha / 2 * Math.cos(T)) : v -= B + r + 3 + x + 3,
                v -= Z)),
                "bottom" == ea ? Y = (H ? X - B - 1 : X + x - 1) + da : (na = va,
                Y = (H ? ma : ma - B - x + 1) - da),
                f && (G += f),
                f = G,
                ...
                0 <= b && b <= X + 1 && (0 < B && 0 < z && b + l <= X + 1 && (fa = d.line(w, [0, B + 1], [b + l, b + l], A, z, D),
                y.push(fa)),
                0 < C && (za = d.line(w, [0, va, ya + va], [b, b + ma, b + ma], L, C, D, I),
                y.push(za)));
                ga = "end";
                if (!0 === H && "left" == ea || !1 === H && "right" == ea)
                    ga = "start";
                v = b - Pa / 2 + 2;
                1 == ia && 0 < O && !g && !m && (e = d.fitToBounds(b, 0, X),
                ca = d.fitToBounds(ca, 0, X),
                T = e - ca,
                Ca = d.polygon(w, [0, a.width, a.width, 0], [0, 0, T, T], S, O),
                Ca.translate(va, e - T + ma),
                y.push(Ca));
                v += r / 2;
                "right" == ea ? (G += va + ya + da,
                v += ma,
                ...
                v -= 2,
                G -= Z);
                fa && ("right" == ea ? (na += va + da + ya - 1,
                Y += ma,
                na = H ? na - x : na + x) : (na -= da,
                H || (na -= B + x)));
                f && (v += f);
                H = -3;
                "right" == ea && (H += ma);
                ba && (v > X + 1 || v < H) && (ba.remove(),
                ba = null )
            }
            fa && (fa.translate(na, Y),
            ...
            if (this.animations)
                for (a = this.animations.length - 1; 0 <= a; a--) {
                    ...
                    if (e <= c) {
                        ...
                        h.node.style[f] = +b.to + b.suffix) : h.node.style[f] = c + b.suffix
                    } else
                        h.node.style[f] = +b.to + b.suffix,
...
(function() {
    ...
    d.AmGraph = d.Class({
        ...
        createRadarGraph: function() {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q))
                    ...
                    n.y = t;
                    if (w = this.labelText)
                        w = this.createLabel(n, w),
                        u = 0,
                        r && (u = r.size),
                        this.positionLabel(n, q, t, w, u);
                    isNaN(f) && (f = q);
                    isNaN(g) && (g = t)
                }
            }
        ...
        positionLabel: function(a, b, c, e, d) {
            if (e) {
                ...
                case "inside":
                    ...
                    q ? p ? (k = "end",
                    b = r - 3 - w) : (k = "start",
                    b = r + 3 + w) : c = p ? u + 7 + w : u - 10 - w);
                    break;
                case "middle":
                    "column" == this.type && (l = !0,
                    q ? b -= (b - r) / 2 + w - 3 : c -= (c - u) / 2 + w - 3)
                }
        ...
        createSerialGraph: function() {
            ...
            isNaN(k) && (k = .8);
            var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, t = this.rotate, r = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2), w = this.connect, y = [], x = [], A, z, B, C, D = this.chart.graphs.length, L, I = this.dx / this.tcc, S = this.dy / this.tcc, O = f.stackType, Q = this.start, ia = this.end, H = this.scrollbar, Z = "graph-column-";
            ...
            T > Ca && (T = Ca);
            var G, v, na, ha = q, Pa = n, ba = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR, Qa = this.negativeFillColors, Ja = this.negativeLineColor, Ya = this.fillAlphas, Za = this.negativeFillAlphas;
            ...
            if (!(H || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round",
            this.resetBullet = !0),
            !Qa && void 0 == Ja || m))) {
                var Ua = Oa;
                Ua > f.max && (Ua = f.max);
            ...
            for (K = Q; K <= ia; K++) {
                ...
                if (m && void 0 == this.openField)
                    for (var yb = K + 1; yb < e.length && (!e[yb] || !(ab = e[K + 1].axes[f.id].graphs[b]) || !ab.values || (Ta = ab.values.value,
                    isNaN(Ta))); yb++)
                        ;
                ...
                if (Ia) {
                    ...
                    isNaN(ta) || (M = f.getCoordinate(ta, xb),
                    m && "regular" != O && "100%" != O && (Ta = ta,
                    ta = M = NaN));
                    ...
                    N = M,
                    M = F = ja,
                    isNaN(ta) && !this.fillToGraph && (N = ma),
                    pa = qa,
                    ra = sa) : (N = E = ja,
                    isNaN(ta) && !this.fillToGraph && (M = ma));
                    if (!Bb && W < ta || Bb && W < za)
                        v.isNegative = !0,
                        Qa && (Ma = Qa),
                        Za && (Va = Za),
                    ...
                    Ob || (void 0 != v.color && (Ma = v.color),
                    v.fillColors && (Ma = v.fillColors));
                    switch (g) {
                    case "line":
                        if (isNaN(W))
                            w || (this.drawLineGraph(y, x, U, V),
                            y = [],
                            x = [],
                            U = [],
                            V = []);
                            ...
                            if ($a || void 0 != v.lineColor && v.lineColor != this.lineColorSwitched || void 0 != v.fillColors && v.fillColors != this.fillColorsSwitched || !isNaN(v.dashLength))
                                ...
                                this.fillColorsSwitched = v.fillColors),
                                this.dashLengthSwitched = v.dashLength;
                            v.gap && (this.drawLineGraph(y, x, U, V),
                            y = [],
                            x = [],
                            U = [],
                            V = [])
                    ...
                    case "smoothedLine":
                        if (isNaN(W))
                            w || (this.drawSmoothedGraph(y, x, U, V),
                            y = [],
                            x = [],
                            U = [],
                            V = []);
                            ...
                            !Ra || isNaN(M) || isNaN(N) || (U.push(N),
                            V.push(M));
                            void 0 == v.lineColor && void 0 == v.fillColors && isNaN(v.dashLength) || (this.drawSmoothedGraph(y, x, U, V),
                            y = [E],
                            x = [F],
                            U = [],
                            V = [],
                            ...
                            this.fillColorsSwitched = v.fillColors,
                            this.dashLengthSwitched = v.dashLength);
                            v.gap && (this.drawSmoothedGraph(y, x, U, V),
                            y = [],
                            x = [],
                            U = [],
                            V = [])
                    ...
                    case "step":
                        if (!isNaN(W)) {
                            ...
                            x.push(F + Ga),
                            y.push(E),
                            !Ra || isNaN(M) || isNaN(N) || (isNaN(B) || (U.push(B),
                            V.push(M - xa)),
                            U.push(N),
                            V.push(M - xa),
                            U.push(N),
                            V.push(M + Ga))) : (isNaN(z) || (x.push(z),
                            y.push(E - xa)),
                            y.push(E - xa),
                            x.push(F),
                            y.push(E + Ga),
                            x.push(F),
                            !Ra || isNaN(M) || isNaN(N) || (isNaN(C) || (U.push(N - xa),
                            V.push(C)),
                            U.push(N - xa),
                            V.push(M),
                            U.push(N + Ga),
                    ...
                    case "column":
                        ...
                        if (!isNaN(W)) {
                            ...
                            if (!(W < Pb && ob < Pb || W > Qb && ob > Qb)) {
                                var Ba;
                                if (t) {
                                    "3d" == O ? (P = F - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + S * ea,
                                    R = N + I * ea,
                                    Ba = ea) : (P = Math.floor(F - (r / 2 - ea) * (k + T) + T / 2),
                                    R = N,
                                    Ba = 0);
                                    J = k;
                                    wa = E;
                                    ...
                                    J = d.roundTo(J, 2);
                                    aa = d.roundTo(aa, 2);
                                    P < q && 0 < J && (ua = new d.Cuboid(h,aa,J,I - a.d3x,S - a.d3y,Ma,Va,ca,Aa,X,ga,u,t,da,bb,mb,Z),
                                    v.columnWidth = Math.abs(aa),
                                    v.columnHeight = Math.abs(J))
                                } else {
                                    "3d" == O ? (R = E - (r / 2 - this.depthCount + 1) * (k + T) + T / 2 + I * ea,
                                    P = M + S * ea,
                                    Ba = ea) : (R = E - (r / 2 - ea) * (k + T) + T / 2,
                                    P = M,
                                    Ba = 0);
                                    J = k;
                                    wa = R + k / 2;
                                    ...
                                    J = d.roundTo(J, 2);
                                    aa = d.roundTo(aa, 2);
                                    R < n + ea * I && 0 < J && (this.showOnAxis && (P -= S / 2),
                                    ua = new d.Cuboid(h,J,aa,I - a.d3x,S - a.d3y,Ma,Va,ca,Aa,this.lineAlpha,ga,u,t,da,bb,mb,Z),
                            ...
                            if (ua) {
                                ...
                                if (!H) {
                                    ...
                                    "3d" == O && (t ? (L = (this.end + 1 - K) * D - c - 1E3 * this.depthCount,
                                    wa += I * this.columnIndex,
                                    ka += I * this.columnIndex,
                                    v.y += I * this.columnIndex) : (L = (D - c) * (K + 1) + 1E3 * this.depthCount,
                                    Da += S * this.columnIndex,
                                    la += S * this.columnIndex,
                                    v.y += S * this.columnIndex));
                                    if ("regular" == O || "100%" == O)
                                        L = t ? 0 < Ia.value ? (this.end + 1 - K) * D + c : (this.end + 1 - K) * D - c : 0 < Ia.value ? D * K + c : D * K - c;
                        ...
                        if (!isNaN(ta) && !isNaN(W)) {
                            ...
                            if (t) {
                                ...
                                if (P < q && 0 < J) {
                                    ...
                                    Eb = [N, pa]) : (Db = [N, ra],
                                    Eb = [E, pa]);
                                    !isNaN(ra) && !isNaN(pa) && F < q && 0 < F && (Xa = d.line(h, Db, [F, F], Aa, X, ca),
                                    cb = d.line(h, Eb, [F, F], Aa, X, ca));
                                    aa = E - N;
                                ...
                                if (R < n && 0 < J) {
                                    ...
                                    Gb = [M, qa]) : (Fb = [M, sa],
                                    Gb = [F, qa]);
                                    !isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [E, E], Fb, Aa, X, ca),
                                    cb = d.line(h, [E, E], Gb, Aa, X, ca),
                            ...
                            if ("regular" == O || "100%" == O) {
                                ...
                                if (Yb) {
                                    ...
                                    if (Na) {
                                        ...
                                        t ? (eb = Da,
                                        db = 0 > W ? E - $b / 2 - 2 - fb - sb : E + $b / 2 + 3 + fb + sb) : (db = wa,
                                        eb = 0 > W ? F + ac / 2 + fb + sb : F - ac / 2 - 3 - fb - sb);
                                        Na.translate(db, eb);
                                        f.totals[K] = Na;
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g)
                "smoothedLine" == g ? this.drawSmoothedGraph(y, x, U, V) : this.drawLineGraph(y, x, U, V),
                H || this.launchAnimation();
        ...
        drawLineGraph: function(a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                void 0 === w || h.useNegativeColorIfDown || (p = d.line(l, a, b, w, r, p, y, !1, !0, f),
                ...
                if (0 < g || 0 < A)
                    ...
                    x || void 0 !== w)
                        isNaN(A) && (A = g),
                        x || (x = w),
                        f = d.polygon(l, p, r, x, A, 1, "#000", 0, a, f),
        ...
        drawSmoothedGraph: function(a, b, c, e) {
            if (1 < a.length) {
                ...
                k.push(m.path);
                void 0 !== r && (n = new d.Bezier(g,a,b,r,x,n,t,0,h),
                ...
                e.reverse(),
                m = a.concat(c),
                p = b.concat(e)) : (this.rotate ? (n += " L" + y + "," + b[b.length - 1],
                n += " L" + y + "," + b[0]) : (n += " L" + a[a.length - 1] + "," + y,
                n += " L" + a[0] + "," + y),
                n += " L" + a[0] + "," + b[0]),
                ...
                u || void 0 !== r) && (w || (w = q),
                u || (u = r),
                a = new d.Bezier(g,a,b,NaN,0,0,u,w,h,n),
        ...
        fixBulletSize: function() {
            if (d.isModern) {
                ...
                if (a) {
                    ...
                    b && !b.doNotScale && (b.translate(a.bx, a.by, 1),
        ...
        showGraphBalloon: function(a, b, c, e, h) {
            ...
            if (g && g.enabled && this.showBalloon && !this.hidden) {
                ...
                g.fixPrevious(),
                g.fixedPosition && (c = !1),
                !c && "radar" != f.type && (b < k || b > a + k || h < l || h > q + l) ? (g.showBalloon(m),
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    n.innerHTML = '<div style="text-align:' + this.textAlign + "; " + D + "max-width:" + this.maxWidth + "px; font-size:" + z + "px; color:" + this.color + "; font-family:" + A + '">' + this.text + "</div>";
                    c.chartDiv.appendChild(n);
                    this.textDiv = n;
                    var L = n.offsetWidth
                      , I = n.offsetHeight;
                    n.clientHeight && (L = n.clientWidth,
                    I = n.clientHeight);
                    A = I + 2 * u;
                    D = L + 2 * r;
                    !isNaN(C) && D < C && (D = C);
                    ...
                    z = b - A - w,
                    this.deltaSignY = 1)) : (2 * w > A && (w = A / 2),
                    z = b - A / 2,
                    a < g + (l - g) / 2 ? (C = a + w,
                    this.deltaSignX = -1) : (C = a - D - w,
                    this.deltaSignX = 1));
                    z + A >= m && (z = m - A);
                    z < k && (z = k);
                    C < g && (C = g);
                    ...
                    this.showBullet && (H = d.circle(h, ia, t, u),
                    f.push(H));
                    this.drop ? (g = D / 1.6,
                    l = 0,
                    "V" == y && (y = "down"),
                    ...
                    k = z - I / 2 + 1,
                    m = C - L / 2 - 1,
                    q = d.drop(h, g, l, q, u, r, p, Z)) : 0 < x || 0 === w ? (0 < O && (a = d.rect(h, D, A, q, 0, r + 1, Q, O, x),
                    d.isModern ? a.translate(1, 1) : a.translate(4, 4),
                    f.push(a)),
                    q = d.rect(h, D, A, q, u, r, p, Z, x)) : (t = [],
                    x = [],
                    "H" != y ? (g = a - C,
                    g > D - w && (g = D - w),
                    g < w && (g = w),
                    t = [0, g - w, a - C, g + w, D, D, 0, 0],
                    x = S ? [0, 0, b - z, 0, 0, A, A, 0] : [A, A, b - z, A, A, 0, 0, A]) : (y = b - z,
                    y > A - w && (y = A - w),
                    y < w && (y = w),
                    x = [0, y - w, b - z, y + w, A, A, 0, 0],
                    t = a < g + (l - g) / 2 ? [0, 0, C < a ? 0 : a - C, 0, 0, D, D, 0] : [D, D, C + D > a ? D : a - C, D, D, 0, 0, D]),
                    0 < O && (a = d.polygon(h, t, x, q, 0, r, Q, O),
                    a.translate(1, 1),
                    f.push(a)),
                    q = d.polygon(h, t, x, q, u, r, p, Z));
                    this.bg = q;
                    f.push(q);
                    q.toFront();
    ...
    d.AmCoordinateChart = d.Class({
        ...
        parsePartSerialData: function(a, b, c, e) {
            ...
            for (x = b; x < c; x++) {
                ...
                q && (B.labelColor = C[q]);
                y[C[g]] = B;
                if (k && (m.categoryFunction ? b = m.categoryFunction(b, C, m) : (!A || b instanceof Date || (b = b.toString() + " |"),
                b = d.getDate(b, A, m.minPeriod)),
                b = d.resetDateToMin(b, r, t, m.firstDayOfWeek),
                B.category = b,
                B.time = b.getTime(),
                isNaN(B.time)))
                    continue;var D = this.valueAxes;
                B.axes = {};
                B.x = {};
                var L;
...
(function() {
    ...
    d.TrendLine = d.Class({
        ...
        draw: function() {
            var a = this;
            a.destroy();
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, u = a.finalXValue, w = a.initialValue, y = a.finalValue, x = p.recalculateToPercents, A = b.dataDateFormat;
            ...
            t && !x && (isNaN(r) || (e = t.getCoordinate(r)),
            isNaN(u) || (h = t.getCoordinate(u)));
            p && !x && (isNaN(w) || (f = p.getCoordinate(w)),
            isNaN(y) || (g = p.getCoordinate(y)));
...
(function() {
    ...
    d.makeHD = function(a, b, c) {
        for (var d = [], h = [], f = 1; f < a.length; f++)
            for (var g = +a[f - 1], k = +b[f - 1], l = +a[f], m = +b[f], n = Math.round(Math.sqrt(Math.pow(l - g, 2) + Math.pow(m - k, 2)) / 50) + 1, l = (l - g) / n, m = (m - k) / n, q = 0; q <= n; q++) {
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        k *= 10,
        u *= 10,
        1 > Math.abs(h) && 1 >= Math.abs(C - z) && 1 >= Math.abs(D - B) && (O = !0));
        h = "";
        var Q;
        q && (I["fill-opacity"] = 0,
        I["stroke-opacity"] = m["stroke-opacity"] / 2,
        I.stroke = m.stroke);
        if (0 < l) {
            Q = " M" + y + "," + (A + l) + " L" + z + "," + (B + l);
            w ? (O || (Q += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + z + "," + (B + l) + "," + C + "," + (D + l)),
            Q += " L" + L + "," + (x + l),
            0 < k && (O || (Q += " B" + (b - k) + "," + (l + c - u) + "," + (b + k) + "," + (l + c + u) + "," + L + "," + (l + x) + "," + y + "," + (l + A)))) : (Q += " A" + f + "," + g + ",0," + S + ",1," + C + "," + (D + l) + " L" + L + "," + (x + l),
            0 < k && (Q += " A" + k + "," + u + ",0," + S + ",0," + y + "," + (A + l)));
            Q += " Z";
            var ia = l;
            w && (ia /= 10);
        ...
        w ? (O || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(z) + "," + r(B) + "," + r(C) + "," + r(D)),
        g = " M" + r(y) + "," + r(A) + " L" + r(z) + "," + r(B) + h + " L" + r(L) + "," + r(x)) : g = " M" + y + "," + A + " L" + z + "," + B + (" A" + f + "," + g + ",0," + S + ",1," + C + "," + D) + " L" + L + "," + x;
        ...
        if (n) {
            ...
            for (w = 0; w < n.length; w++)
                u.push(d.adjustLuminosity(m.fill, n[w]));
...
(function() {
    ...
    d.SVGRenderer = d.Class({
        ...
        pattern: function(a, b, c, e) {
            ...
            c = b.x;
            isNaN(c) && (c = 0);
            var m = -Math.random() * +b.randomX;
            isNaN(m) || (c = m);
            m = b.y;
            isNaN(m) && (m = 0);
            var n = -Math.random() * +b.randomY;
            isNaN(n) || (m = n);
            f.setAttribute("id", g);
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (A = 0; A < y.length; A++) {
                ...
                x = L.getBBox();
                var I;
                this.equalWidths ? I = z * (p + n + this.markerLabelGap) : (I = B,
                B = B + x.width + f + n);
                x.height > D && (D = x.height);
                I + x.width > q && 0 < A && 0 !== z && (t++,
                I = z = 0,
                B = I + x.width + f + n,
                C = C + D + m,
                D = 0);
            ...
            if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
                "center" == this.align ? b = f + (n - x.width) / 2 : "right" == this.align && (b = f + n - x.width);
            w.translate(b, m + 1);
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                t = this.fontSize;
                g && (m <= t && (m = m / 2 + this.ly - t / 2 + (t + 2 - m) / 2 - q,
                g.translate(p, m),
                u && u.translate(u.x, m)),
                ...
                a.legendTextReal = e,
                w = this.labelWidth,
                w = isNaN(w) ? d.text(this.container, e, f, b.fontFamily, t, "start") : d.wrappedText(this.container, e, f, b.fontFamily, t, "start", !1, w, 0),
                d.setCN(b, w, "legend-label"),
                w.translate(this.lx + n, this.ly),
                l.push(w),
                b = w.getBBox().width,
