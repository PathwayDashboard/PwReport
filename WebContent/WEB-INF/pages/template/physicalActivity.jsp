...
<!-- 							<div class="row"> &nbsp;</div> -->
								...
								<div class="row" >
									<div class="col-lg-12"
										style="background-color: #b8c8a9; height: 40px; padding-top: 10px; padding-left: 5px; padding-right: 5px; padding-bottom: 10px; margin-bottom: 5px">
										<b><span style="vertical-align: middle"><spring:message
													code="dashboard.label.todo" /></span></b>
									</div>
								</div>
