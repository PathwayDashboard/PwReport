						...
						<div class="panel-heading" role="tab" id="heading${count}">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<div class="col-lg-2">
									<img height="25px"
											src="resources/images/jpg/run.png" />
									</div>
									
									<div class="col-lg-2">
									<span
											class="glyphicon glyphicon-fire" aria-hidden="true"></span>
											<span id="kcal_${count}">${currentRun.caloriesBurnedSummary.totalCalories}</span>
									</div>
									
									<div class="col-lg-2">
											<i class="fa fa-heartbeat"></i>
											<span id="hr_${count}">${currentRun.heartRateSummary.averageHeartRate}</span>
									</div>
